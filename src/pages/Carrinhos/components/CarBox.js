...
import { IconActionless, TextLimit, Price } from '../../../components';
...
class CarBox extends React.Component {
        ...
        >
          <View style={styleCB.vwLastOrder}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ fontFamily: Font.ARegular, fontSize: 16 }}>{item.sfa_pricebook2_name}</Text>
  ...
  handleClick = async () => {
    ...
    this.props.navigation.navigate('carrinho', { BackSpace: true, wasInCarts: true });
  }
}
