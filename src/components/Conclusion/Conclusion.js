...
class Conclusion extends React.Component {
  ...
  render() {
    return (
      <Animated.View style={{maxWidth:1024, paddingHorizontal: 40, paddingTop: 30, opacity: this.state.fadeAnim }}>
        <Text style={[global.p1,{lineHeight:24}]}>Todos os dados e mídias foram carregados. Boas Vendas!</Text>
